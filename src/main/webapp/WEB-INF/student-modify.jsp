...
<main class="main">
  ...
  <h2 class="heading-secondary">Для модифицырования студента отредактируйте поля и нажмите кнопку "применить"</h2>
  <form action="/student-modify" method="post">
    ...
    <table>
      <tr>
        ...
        <td><input name="groupe" type="text" id="name" value="${student.group}"> </td>
      </tr>
    </table>
    <br>
    <table>
      <tr>
        ...
        <td> <input name="date" type="text" id="datepicker" value="<fmt:formatDate value="${student.date}"
